...
final class AuthFilterMiddleware extends BaseMiddleware
{
    ...
    private function Filter(array $data) {
        ...
        // Si des champs obligatoires manquent, on retourne immédiatement les erreurs
        if (!empty($errors)) {
            return $this->json("Erreurs de validation", $errors);
        }
        ...
        if (!$this->MinMaxStr($data["email"], 2, 255)) {  // 255 est la longueur max standard pour les emails
