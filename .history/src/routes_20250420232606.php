...
$app->get(ENTRY_POINT . '/auth/remake-new-code', AuthController::class . ":GetRemakeNewCode");
$app->get(ENTRY_POINT . '/auth/verifie-code', AuthController::class . ":GetRemakeNewCode");
