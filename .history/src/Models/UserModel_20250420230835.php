...
final class UserModel{
    ...
    //updates
    public static function UpdatePinCodeUser(string $newCode):bool{
        $conn = DBConnection::GetConnection("sinox");
        $sth=$conn->prepare("UPDATE user SET emailVerificationCode=?;");
        $sth->bindParam(1 , $newCode ,PDO::PARAM_STR , 50);
    }
