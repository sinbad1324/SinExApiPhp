...
final class ManuelAuthServices {
    ...
    public function RegitreNewUser():string  {
       ...
       if (UserModel::CreateManuelUser($this->UserData ,$CodePin)) {
            //Envoyer un mail
            return $this->json("Nous vous avons envoyer un mail a votre mail vouliez vous nous donner ce code." , ["code"=>CodePin]) // atention c'est mode dbug ici il foudra enlever code de data 
       }
    }
