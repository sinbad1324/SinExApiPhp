...
final class JWTVerificationMiddelware extends BaseMiddleware
{
    protected function  Execute(Request $request, RequestHandler $handler): Response
    {
        ...
        $ignoreUrls = ["/api/auth/register","/api/gmail/sendMail","/api/auth/connection","/api/auth/remake-new-code","/api/auth/double-verifie-code","/api/auth/verifie-code","/api/auth/google-connection","/api/auth/google-get-connection" ];
